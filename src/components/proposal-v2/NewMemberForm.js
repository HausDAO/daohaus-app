...
const NewMemberForm = (props) => {
    ...
    useEffect(() => {
        if (data && data.moloch) {
            ...
            setTokenData(data.moloch.approvedTokens.reverse().map((token) => ({ label: token.ticker || token.tokenAddress, value: token.tokenAddress })));
                        ...
                        >
                            {({ isSubmitting, ...props }) => (
                                <Form className="Form">
                                    ...
                                    <Field name="tributeOffered" component={TributeInput} label="Token Tribute" token={props.values.tributeToken} ></Field>
