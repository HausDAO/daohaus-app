              ...
              <>
                ...
                <GenericModal modalId='ccoProcess'>
                  <Box>
                    ...
                    <Text mb={5}>
                      We have scraped a ton of dao contracts, including
                      &apos;The DAO&apos;, Ethereum&apos;s first major attempt
                      at a DAO. There are ~122k addresses that have ‘proven’
                      eligible for HAUS distribution, all of the below actions
                      demonstrate a willingness to govern within the Ethereum
                      ecosystem and therefore are included:
                      <ul>
                        <li>
                        ...
                        <li>
                          All stakers scraped from the Yearn Staked Event
                          Emitted
                        </li>
                        <li>
                          All addresses with VoteCast or DelegateChanged from
                        ...
                        <li>
                          All addresses that were in the ‘to or from’ fields
                          from DXDAO
                        </li>
                    ...
                    <Text>
                      ...
                      <br />
                      IF min target is reached, contributors will be able to
                      claim their proportionate HAUS tokens.
                      <br />
                      IF min target is not reached after Round 2, contributors
                      will be able to withdraw their original wxDAI
                      contributions.
                    </Text>
                  </Box>
                </GenericModal>
                ...
                <Button variant='outline'>Add xDAI to Metamask</Button> */}
                  ...
                  <Text mb={3}>
                    3. Switch to xDAI network in Metamask, and you should see
                    your xDAI balance.
                  </Text>
                  <Text>
